...
<head>
  ...
  <title>Mars API - Get Free APIs of Many Website - Public or Scrapped - Use even from JavaScript</title>
...
<body class="container">
  <br><hr><br>
  <header>
    <h1>Mars API - Get Free APIs of Many Website - Public or Scrapped - Use even from JavaScript</h1>
  </header>
  <br><hr><br>
