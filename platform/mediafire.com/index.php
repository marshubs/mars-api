...
<div class="cover">
  ...
  <div id="madeby">
    <span>
      Try - https://wholly-api.herokuapp.com/platform/mediafire.com/direct_download.php?id=<b>YOUR_FILE_ID</b>
    </span>
  </div>
</div>
...
function grab() {
 let i = 'https://marshubs.github.io/mars-api/platform/mediafire.com/direct_download.php?id='+document.getElementById('url').value.split("/")[4]+'';
